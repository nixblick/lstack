...
database
    ...
    Variablen:
        ...
        database_vip, database_name, database_user_client, database_password_client, database_enable_postgis, database_paths
...
auth_ldap_client
    ...
    Variablen:
        ...
        auth_ldap_uri, auth_ldap_base_dn, auth_ldap_bind_dn, auth_ldap_bind_pw, auth_ldap_role_map, auth_offline_cache_ttl
...
client
    ...
    Variablen:
        ...
        client_package_url, client_install_dir, client_config.db_*, client_config.ldap_*, client_runtime_user/group
...
gateway_weather
    ...
    Variablen:
        ...
        gateway_weather_api_url, gateway_weather_api_key, gateway_weather_interval, gateway_weather_target_table
...
gateway_geocode
    ...
    Variablen:
        ...
        gateway_geocode_api_url, gateway_geocode_interval, gateway_geocode_target_table
...
gateway_phone (Bonus)
    ...
    Variablen:
        ...
        gateway_phone_engine, gateway_phone_sip_user, gateway_phone_sip_password, gateway_phone_cti_table
...
gateway_tetra_internal (Bonus)
    ...
    Variablen:
        ...
        gateway_tetra_internal_device, gateway_tetra_internal_protocol, gateway_tetra_internal_table
...
gateway_tetra_external (Bonus)
    ...
    Variablen:
        ...
        gateway_tetra_external_api_url, gateway_tetra_external_api_key, gateway_tetra_external_table
...
gateway_alarmprinter (Bonus)
    ...
    Variablen:
        ...
        gateway_alarmprinter_output_dir, gateway_alarmprinter_messenger, gateway_alarmprinter_matrix_*, gateway_alarmprinter_jobs_table
...
tile_server (optional)
    ...
    Variablen:
        ...
        tile_data_dir, tile_region, tile_db_user, tile_db_password
...
webserver_stats
    ...
    Variablen:
        ...
        webserver_stats_port, webserver_stats_auth_user, webserver_stats_auth_password, webserver_stats_dashboards
...
backup
    ...
    Variablen:
        ...
        backup_target_dir, backup_retention_days, backup_cron_time, backup_include_paths, backup_db.*, restore_source_dir
...
roles/auth_ldap_client/README.md

roles/client/README.md

roles/gateway_weather/README.md

roles/gateway_geocode/README.md

roles/gateway_phone/README.md

roles/gateway_tetra_internal/README.md

roles/gateway_tetra_external/README.md

roles/gateway_alarmprinter/README.md

roles/tile_server/README.md

roles/webserver_stats/README.md
